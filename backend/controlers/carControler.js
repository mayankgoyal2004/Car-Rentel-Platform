...
const toggleAvailabilityByAdmin = async (req, res) => {
  try {
...
const toggleFeaturedBySuperAdmin = async (req, res) => {
  try {
    const { id } = req.params;
    const { isFeatured } = req.body;

    const car = await Car.findByIdAndUpdate(id, { isFeatured }, { new: true });
