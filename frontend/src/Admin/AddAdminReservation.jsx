...
const AddAdminReservation = () => {
  ...
  <div className="content me-4 pb-0">
    <div className="mb-3">
      <a href="reservations.html" className="d-inline-flex align-items-center fw-medium"><i className="ti ti-arrow-narrow-left me-2" />Reservation</a>
    </div>
    <div className="wizard-form">
      <fieldset id="first-field">
        <div className="row">
          <div className="col-lg-8">
            <form action="add-reservation.html">
              <div className="card">
          ...
          <div className="col-lg-8">
            <form action="add-reservation.html">
              <div className="card">
                <div className="card-body">
                  <div className="reservation-wizard mb-4">
                    <ul className="d-flex align-items-center flex-wrap row-gap-2" id="progressbar1">
                            ...
                            <div className="row gx-2 gy-3">
                              ...
                              <div className="col-md-4">
                                <div>
                                  ...
                                  <p><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="62030c06100715515622071a030f120e074c010d0f">[email&nbsp;protected]</a></p>
                                </div>
                              </div>
                            </div>
                          </div>
          ...
          <div className="col-lg-8">
            <form action="add-reservation.html">
              <div className="card">
                <div className="card-body">
                  <div className="reservation-wizard mb-4">
                    <ul className="d-flex align-items-center flex-wrap row-gap-2" id="progressbar2">
                      <li className="d-flex align-items-center activated me-2">
                        <span className="me-2 wizard-icon"><i className="ti ti-calendar" /></span>
                        <span className="active-check me-2"><i className="ti ti-check" /></span>
                        <h6>Car &amp; Dates Info</h6>
          ...
          <div className="col-lg-8">
            <form action="add-reservation.html">
              <div className="card">
                <div className="card-body">
                  <div className="reservation-wizard mb-4">
                    <ul className="d-flex align-items-center flex-wrap row-gap-2" id="progressbar3">
                      <li className="d-flex align-items-center activated me-2">
                        <span className="me-2 wizard-icon"><i className="ti ti-calendar" /></span>
                        <span className="active-check me-2"><i className="ti ti-check" /></span>
                        <h6>Car &amp; Dates Info</h6>
