                  ...
                  <div className="row row-gap-4">
                    ...
                    <div className="col-xl-9">
                      ...
                      <div className="mb-3">
                        ...
                        <input type="text" className="form-control" placeholder="https://www.example.com/cars/" />
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="mb-3">
                            ...
                            <select className="select">
                              <option>Select</option>
                              <option>Johnson Dealer Zone</option>
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="mb-3">
                            ...
                            <div className="input-icon-end position-relative">
                              <input type="text" className="form-control yearpicker" />
                    ...
                    <div className="col-xl-9">
                      <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6">
                          <div className="mb-3">
                            <div className="form-check form-checkbox mb-0">
                              <input className="form-check-input" type="checkbox" id="amenity5" />
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-8">
                          <div className="mb-4">
                            ...
                            <input type="text" className="form-control" placeholder="https://www.youtube.com/cars_add/" />
                          </div>
                        </div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content">
        <div className="modal-body text-center">
          ...
          <div className="d-flex justify-content-center">
            <a href="javascript:void(0);" className="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
            <Link to="/admin-dashboard/add-car" className="btn btn-primary">Yes, Delete</Link>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content">
        <div className="modal-body text-center">
          ...
          <div className="d-flex justify-content-center">
            <a href="javascript:void(0);" className="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
            <Link  to="add-car" className="btn btn-primary">Yes, Delete</Link>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content">
        <div className="modal-body text-center">
          ...
          <div className="d-flex justify-content-center">
            <a href="javascript:void(0);" className="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
            <a href="add-car" className="btn btn-primary">Yes, Delete</a>
          </div>
        </div>
      </div>
    </div>
