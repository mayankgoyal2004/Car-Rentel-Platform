      ...
      <div className="custom-datatable-filter table-responsive">
        <table className="table datatable">
          ...
          <tbody>
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Travel Tips</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Car Reviews</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Insurance &amp; Coverage</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Budget Rentals</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Luxury Car Rentals</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Road Trip Guides</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Eco-Friendly Rentals</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Seasonal Deals</a>
              </td>
              <td>
            ...
            <tr>
              <td>
                <a href="javascript:void(0);" className="fw-medium">Customer Stories</a>
              </td>
              <td>
                <a href="javascript:void(0);" className="fw-medium">18</a>
              </td>
