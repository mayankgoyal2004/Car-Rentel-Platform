...
<div>
    ...
    <div className="content me-4">
      ...
      <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap">
          <div className="mb-2">
            <a href="javascript:void(0);" className="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_booking"><i className="ti ti-plus me-2" />Add New Booking</a>
          </div>
        </div>
      </div>
      {/* /Breadcrumb */}
      <div className="row">
        <div className="col-md-10">
          <ul className="nav nav-tabs nav-tabs-solid custom-nav-tabs bg-transparent mb-3" role="tablist">
            <li className="nav-item" role="presentation"><a className="nav-link active" href="#">All Bookings</a></li>
            <li className="nav-item" role="presentation"><a className="nav-link" href="#">In Progress</a></li>
            <li className="nav-item" role="presentation"><a className="nav-link" href="#">Confirmed</a></li>
            <li className="nav-item" role="presentation"><a className="nav-link" href="#">Completed</a></li>
            <li className="nav-item" role="presentation"><a className="nav-link" href="#">Rejected</a></li>
          </ul>
        </div>
        ...
        <div className="filterbox mb-3 d-flex align-items-center">
          ...
          <div className="dropdown me-2">
            ...
            <ul className="dropdown-menu dropdown-menu-lg p-2">
              ...
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />David Steiger
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Darin Mabry
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
          ...
          <div className="dropdown me-2">
            ...
            <ul className="dropdown-menu dropdown-menu-lg p-2">
              ...
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Reuben Keen
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />William Jones
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Leonard Jandreau
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Adam Bolden
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Harvey Jimenez
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />William Ward
                </label>
              </li>
            </ul>
          </div>
                        ...
                        <div className="row align-items-center">
                          ...
                          <div className="col-lg-8">
                            <div className="d-flex align-items-center justify-content-end flex-wrap row-gap-3 mb-3">
                              <div className="dropdown me-2">
                                <a href="#filtercollapse2" className="filtercollapse coloumn d-inline-flex align-items-center" data-bs-toggle="collapse" role="button" aria-expanded="true" aria-controls="filtercollapse2">
                                  <i className="ti ti-filter me-1" /> Filter <span className="badge badge-xs rounded-pill bg-danger ms-2">0</span>
                                </a>
                              </div>
                                ...
                                <div className="row gx-2 gy-3">
                                  ...
                                  <div className="col-md-4">
                                    <div>
                                      ...
                                      <p><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="e2838c86908795d1d6a2879a838f928e87cc818d8f">[email&nbsp;protected]</a></p>
                                    </div>
                                  </div>
                                </div>
                              </div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content">
        <div className="modal-body text-center">
          <form action="reservation-details.html">
  ...
  <div className="modal fade" id="event_modal">
    <div className="modal-dialog modal-dialog-centered">
      <div className="modal-content">
        <div className="modal-header">
          <h4 className="d-inline-flex align-items-center">Booking Details<a href="javascript:void(0);" className="ms-2"><i className="ti ti-edit" /></a></h4>
          <button type="button" className="btn-close custom-btn-close" data-bs-dismiss="modal" aria-label="Close">
            <i className="ti ti-x" />
          </button>
        </div>
        <div className="modal-body">
            ...
            <div className="border rounded p-3 bg-light mb-3">
              <div className="row">
                ...
                <div className="col-3">
                  <div>
                    <h6 className="fs-14 mb-1">Price</h6>
                    <p className="fs-14 text-gray-9">$60<span className="text-gray-5 fw-normal">/day</span></p>
                  </div>
                </div>
                <div className="col-3">
                  <div>
          ...
          <div className="border-bottom mb-3">
            <div className="d-flex align-items-center justify-content-between">
              <div className="mb-3">
                <h6 className="d-inline-flex align-items-center fs-14 fw-medium ">Customer</h6>
              </div>
            ...
            <div className="d-flex align-items-center justify-content-between">
              <div className="mb-3">
                <h6 className="d-inline-flex align-items-center fs-14 fw-medium ">Driver</h6>
              </div>
              <div className="d-flex align-items-center mb-3">
                <span className="avatar avatar-rounded flex-shrink-0 me-2">
                  <img src="/admin-assets/img/customer/customer-01.jpg" alt />
