                  ...
                  <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                    <div className="d-flex align-items-center">
                      ...
                      <div>
                        <h6>{car.carName}</h6>
                        <div className="d-flex align-items-center">
                          <p className="mb-0 me-2">{car?.carType?.carType}</p>
                        ...
                        <div className="row">
                          ...
                          <div className="col-xxl-3 col-md-4 col-sm-6">
                            <div className="mb-3">
                              ...
                              <p className="fs-13">{car?.carModel?.carModel}</p>
                            </div>
                          </div>
                          <div className="col-xxl-3 col-md-4 col-sm-6">
                            <div className="mb-3">
                              <h6 className="fs-14 fw-semibold mb-1">Type</h6>
                              <p className="fs-13">{car?.carType?.carType}</p>
                            </div>
                          </div>
                          <div className="col-xxl-3 col-md-4 col-sm-6">
                            <div className="mb-3">
                          ...
                          <div className="col-xxl-3 col-md-4 col-sm-6">
                            <div className="mb-3">
                              ...
                              <p className="fs-13">{car?.carSeats?.carSeats}</p>
                            </div>
                          </div>
                          <div className="col-xxl-3 col-md-4 col-sm-6">
                            <div className="mb-3">
