      ...
      <div className="collapse" id="filtercollapse">
        <div className="filterbox mb-3 d-flex align-items-center">
          ...
          <div className="dropdown me-2">
            ...
            <ul className="dropdown-menu dropdown-menu-end p-2">
              <li>
                <a href="javascript:void(0);" className="dropdown-item rounded-1">One Time</a>
              </li>
              <li>
                <a href="javascript:void(0);" className="dropdown-item rounded-1">Per Day</a>
              </li>
            </ul>
          </div>
        ...
        <table className="table datatable">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">GPS Navigation System</a></h6>
              </td>
              <td>$30</td>
              <td>Per Day</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Roof Box Storage</a></h6>
              </td>
              <td>$100</td>
              <td>One Time</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Camping Equipment</a></h6>
              </td>
              <td>$130</td>
              <td>One Time</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Glass &amp; Tire Protection</a></h6>
              </td>
              <td>$150</td>
              <td>One Time</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Mini Refrigerator</a></h6>
              </td>
              <td>$80</td>
              <td>One Time</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Wi-Fi Hotspot</a></h6>
              </td>
              <td>$30</td>
              <td>Per Day</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Express Check-in/Check-out</a></h6>
              </td>
              <td>$200</td>
              <td>One Time</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Air Purifier</a></h6>
              </td>
              <td>$40</td>
              <td>Per Day</td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Sanitization Kit</a></h6>
              </td>
              <td>$60</td>
              <td>One Time</td>
              <td>
