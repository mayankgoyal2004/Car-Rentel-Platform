    ...
    <div className="content me-0">
      <div className="row justify-content-center">
        <div className="col-lg-8">
          <div className="mb-3">
            <Link to="all-customers" className="d-inline-flex align-items-center fw-medium"><i className="ti ti-arrow-left me-1" />Client</Link>
          </div>
          <div className="card">
              ...
              <div className="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div className="d-flex align-items-center">
                  <span className="avatar avatar-lg me-3">
                    <img src="/admin-assets/img/customer/customer-01.jpg" alt="img" />
                  </span>
                  <div>
                ...
                <div className="d-flex align-items-center flex-wrap gap-3">
                  <span className="badge badge-md bg-info-transparent">License Number : ABC123456</span>
                  <span className="badge badge-md bg-orange-transparent">Valid Till : 20 Feb 2027</span>
                </div>
              </div>
            </div>
          </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4 col-sm-6">
                        <div className="mb-3">
                          ...
                          <p className="fs-13"><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="2e585c5a57161a176e4b564f435e424b004d4143">[email&nbsp;protected]</a></p>
                        </div>
                      </div>
                  ...
                  <div>
                    ...
                    <div className="d-flex align-items-center flex-wrap gap-4">
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fs-14 fw-medium">Liscence Document.pdf</h6>
                        ...
                        <div className="row gy-3 align-items-center">
                            ...
                            <div className="row gy-3 align-items-center">
                              <div className="col-lg-4">
                                <div className="d-flex align-items-center">
                                  ...
                                  <div>
                                    <Link to="car-details" className="text-info">#BR3466</Link>
                          ...
                          <div className="col-lg-3">
                            <div className="d-flex align-items-center icon-list justify-content-end">
                              <Link to="invoice-details"  className="edit-icon me-2"><i className="ti ti-eye" /></Link>
                            ...
                            <div className="row gy-3 align-items-center">
                              <div className="col-lg-4">
                                <div className="d-flex align-items-center">
                                  ...
                                  <div>
                                    <Link to='car-details' className="text-info">#BR3467</Link>
                            ...
                            <div className="row gy-3 align-items-center">
                              <div className="col-lg-4">
                                <div className="d-flex align-items-center">
                                  ...
                                  <div>
                                    <Link to="car-details"className="text-info">#BR3468</Link>
                            ...
                            <div className="row gy-3 align-items-center">
                              <div className="col-lg-4">
                                <div className="d-flex align-items-center">
                                  ...
                                  <div>
                                    <Link to="car-details" className="text-info">#BR3469</Link>
                            ...
                            <div className="row gy-3 align-items-center">
                              <div className="col-lg-4">
                                <div className="d-flex align-items-center">
                                  ...
                                  <div>
                                    <Link to="car-details" className="text-info">#BR3470</Link>
          ...
          <div className="row">
            <div className="mb-3">
              ...
              <div className="d-flex align-items-center flex-wrap row-gap-3">                                                
                <div className="d-flex align-items-center justify-content-center avatar avatar-xxl border me-3 flex-shrink-0 text-dark frames p-2">
                  <img src="/admin-assets/img/customer/customer-11.jpg" className="img-fluid rounded" alt="img" />
            ...
            <div className="col-md-4">            
              <div className="mb-3">
                ...
                <div className="input-icon-end position-relative">
                  <input type="text" className="form-control datetimepicker" placeholder="24 Jan 1995" />
            ...
            <div className="col-md-4">
              <div className="mb-3">
                ...
                <input className="form-control" type="text" id="phone2" name="phone2" defaultValue="+56598 98956 " />
              </div>
            </div>            
            <div className="col-md-4">
              <div className="mb-3">
            ...
            <div className="col-md-4">
              <div className="mb-3">
                ...
                <input type="text" className="form-control" defaultValue="DL123456789" />
              </div>
            </div>  
            <div className="col-md-4">            
              <div className="mb-3">
