...
const AdminInvoiceDetails = () => {
  ...
  <div className="content me-4">
    <div className="mb-3">
      <Link to="account-invoice"  className="d-inline-flex align-items-center fw-medium"><i className="ti ti-arrow-narrow-left me-2" />Back to List</Link>
    </div>
    <div className="filterbox mb-3 d-flex align-items-center invoice-title">
      <h4 className="me-3"><i className="ti ti-menu-2 me-2" />Invoice Details</h4>
    </div>
        ...
        <div className="row justify-content-between align-items-center border-bottom mb-3">
          <div className="col-md-6">
            <div className="  mb-3">
              ...
              <p className="fw-medium d-flex"><span className="text-dark min-width-100 d-flex">Due Date</span>Sep 30, 2025 </p>
            </div>
          </div>
          <div className="col-md-6">
            <div className=" text-end mb-2">
              <img src="/admin-assets/img/logo.svg" className="invoice-logo img-fluid" alt="logo" />
              <p className="mb-2">Flat8, Park View House, 7 high Street , US</p>
              <span className="badge badge-soft-violet"><i className="ti ti-point-filled me-1" />Partially Paid</span>
            </div>
          </div>
        </div>
            ...
            <div className="card bg-light">
              <div className="card-body">
                ...
                <div>
                  ...
                  <p><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="02667067636f7170676c7642677a636f726e672c616d6f">[email&nbsp;protected]</a></p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="card bg-light">
              <div className="card-body">
                ...
                <div>
                  ...
                  <p className="mb-1">Contact : <span className="text-dark">+447123456789</span></p>
                  <p><a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="d2abbda7a0e3e0e192b7aab3bfa2beb7fcb1bdbf">[email&nbsp;protected]</a></p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="d-flex justify-content-center align-items-center mb-4">
      <a href="javascript:void(0);" className="btn btn-primary d-flex justify-content-center align-items-center me-2"><i className="ti ti-printer me-2" />Print Invoice</a>
      <a href="javascript:void(0);" className="btn btn-dark d-flex justify-content-center align-items-center border"><i className="ti ti-download me-2" />Download Invoice</a>
    </div>
  </div>			
</div>
