      ...
      <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        ...
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
          <div className="mb-2 me-2">
            <a href="javascript:void(0);" className="btn btn-primary d-flex align-items-center" data-bs-toggle="modal" data-bs-target="#add_city"><i className="ti ti-plus me-2" />Add City</a>
          </div>
        </div>
      </div>
      {/* /Breadcrumb */}
        ...
        <div className="filterbox mb-3 d-flex align-items-center">
          ...
          <div className="dropdown me-2">
            <a href="javascript:void(0);" className="dropdown-toggle btn btn-white d-inline-flex align-items-center" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              <span className="badge badge-xs rounded-pill bg-success me-2">5</span>State Name Selected
            </a>
            <ul className="dropdown-menu dropdown-menu-lg p-2">
              ...
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />California
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />New York
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Texas
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Baveria
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Quebec
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Ontario
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Florida
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Berlin
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Victoria
                </label>
              </li>
              <li>
                <label className="dropdown-item d-flex align-items-center rounded-1">
                  <input className="form-check-input m-0 me-2" type="checkbox" />Gauteng
                </label>
              </li>
            </ul>
          </div>
          <div className="dropdown me-2">
            <a href="javascript:void(0);" className="dropdown-toggle btn btn-white d-inline-flex align-items-center" data-bs-toggle="dropdown" data-bs-auto-close="outside">
              <span className="badge badge-xs rounded-pill bg-success me-2">1</span>Country Name Selected
            </a>
            <ul className="dropdown-menu dropdown-menu-lg p-2">
              <li>
                <div className="top-search m-2">
      ...
      <div className="custom-datatable-filter table-responsive brandstable country-table">
        <table className="table datatable">
          ...
          <tbody>
            <tr>
              <td>
                <p className="text-gray-9">Los Angles</p>
              </td>
              <td>
              ...
              <td>
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end p-2">
                    <li>
                      <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_city"><i className="ti ti-edit me-1" />Edit</a>
                    </li>
                    <li>
                      <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_city"><i className="ti ti-trash me-1" />Delete</a>
                    </li>
                  </ul>
                </div>
              </td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">New York City</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Houston</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Munich</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Montreal</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Toronto</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Miami</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Calgary</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Melbourne</p>
              </td>
              <td>
            ...
            <tr>
              <td>
                <p className="text-gray-9">Johannesburg</p>
              </td>
              <td>
      ...
      <div className="modal-content">
        ...
        <div className="modal-footer">
          <div className="d-flex justify-content-center">
            ...
            <Link to="/admin-dashboard/location-cities" className="btn btn-primary">Create New</Link>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-md">
      <div className="modal-content">
        ...
        <div className="modal-body pb-1">
          <div className="mb-3">
            <label className="form-label">City Name <span className="text-danger">*</span></label>
            <input type="text" className="form-control" defaultValue="Los Angles" />
          </div>                     
          <div className="mb-3">
            <label className="form-label">State Name <span className="text-danger">*</span></label>
            <select className="select">
        ...
        <div className="modal-footer">
          <div className="d-flex justify-content-between align-items-center w-100">
            ...
            <div className="d-flex justify-content-center">
              <a href="javascript:void(0);" className="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
              <Link to="/admin-dashboard/location-cities" className="btn btn-primary">Save Changes</Link>
            </div>
          </div>						
        </div>
      </div>
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content">
        <div className="modal-body text-center">
          ...
          <div className="d-flex justify-content-center">
            <a href="javascript:void(0);" className="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
            <Link to="/admin-dashboard/location-cities" className="btn btn-primary">Yes, Delete</Link>
          </div>
        </div>
      </div>
    </div>
