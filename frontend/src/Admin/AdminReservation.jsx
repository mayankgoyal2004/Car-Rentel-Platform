          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link  to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3466</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Ford Endeavour</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                <Link to="/admin-dashboard/car-details" className="avatar avatar-rounded me-2 flex-shrink-0"><img src="/admin-assets/img/customer/customer-01.jpg" alt /></Link>
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/company-details">Reuben Keen</Link></h6>
            ...
            <td>
              <div className="dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end p-2">
                  <li>
                    <Link to="/admin-dashboard/reservation-details" className="dropdown-item rounded-1"><i className="ti ti-eye me-1" />View Details</Link>
                  </li>
                  <li>
                    <Link to="/admin-dashboard/edit-reservation" className="dropdown-item rounded-1" ><i className="ti ti-edit me-1" />Edit</Link>
                  </li>
                  <li>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3467</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Ferrari 458 MM</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                <Link to="/admin-dashboard/company-details" className="avatar avatar-rounded me-2 flex-shrink-0"><img src="/admin-assets/img/customer/customer-02.jpg" alt /></Link>
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/company-details">William Jones</Link></h6>
            ...
            <td>
              <span className="badge bg-orange-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Confirmed
              </span>
            </td>
            <td>
              <div className="dropdown">
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3468</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Ford Mustang </Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                <Link to="/admin-dashboard/company-details" className="avatar avatar-rounded me-2 flex-shrink-0"><img src="/admin-assets/img/customer/customer-03.jpg" alt /></Link>
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/company-details">Leonard Jandreau</Link></h6>
                  <span className="badge bg-violet-transparent rounded-pill">Company</span>
                </div>
              </div>
            </td>
            ...
            <td>
              <span className="badge bg-violet-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />In Rental
              </span>
            </td>
            <td>
              <div className="dropdown">
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3469</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Toyota Tacoma 4</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/customer-details">Adam Bolden</Link></h6>
                  <span className="badge bg-secondary-transparent rounded-pill">Client</span>
                </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3470</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Chevrolet Truck	</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                <Link to="/admin-dashboard/company-details" className="avatar avatar-rounded me-2 flex-shrink-0"><img src="/admin-assets/img/customer/customer-05.jpg" alt /></Link>
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/company-details">Harvey Jimenez</Link></h6>
                  <span className="badge bg-violet-transparent rounded-pill">Company</span>
                </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3471</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Etios Carmen	</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/customer-details">William Ward</Link></h6>
                  <span className="badge bg-secondary-transparent rounded-pill">Client</span>
                </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3472</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Acura Sport </Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/customer-details">Norman Coleman</Link></h6>
                  <span className="badge bg-secondary-transparent rounded-pill">Client</span>
                </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3473</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Kia Soul 2016</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                <Link to="/admin-dashboard/company-details" className="avatar avatar-rounded me-2 flex-shrink-0"><img src="/admin-assets/img/customer/customer-08.jpg" alt /></Link>
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/company-details">Jay Beckman</Link></h6>
                  <span className="badge bg-violet-transparent rounded-pill">Company</span>
                </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3474</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Camaro</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/customer-details">Francis Harris</Link></h6>
                  <span className="badge bg-secondary-transparent rounded-pill">Client</span>
                </div>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <Link to="/admin-dashboard/reservation-details" className="text-info d-block mb-1">#BR3475</Link>
                  <h6 className="fs-14"><Link to="/admin-dashboard/car-details">Toyota Camry</Link></h6>
                </div>
              </div>
            </td>
            <td>
              <div className="d-flex align-items-center">
                ...
                <div>
                  <h6 className="mb-1 fs-14"><Link to="/admin-dashboard/company-details">Renaldo Labarre</Link></h6>
                  <span className="badge bg-violet-transparent rounded-pill">Company</span>
                </div>
              </div>
            </td>
            ...
            <td>
              <span className="badge bg-violet-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />In Progress
              </span>
            </td>
            <td>
              <div className="dropdown">
