        ...
        <div className="my-auto mb-2">
          ...
          <nav>
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active" aria-current="page">Fuel</li>
            </ol>
          </nav>
        </div>
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap">                        
          <div className="mb-2">
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_fuel" className="btn btn-primary d-flex align-items-center"><i className="ti ti-plus me-2" />Add New Fuel</a>
          </div>
        </div>
      </div>
      {/* /Breadcrumb */}
        ...
        <table className="table">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Petrol</a></h6>
              </td>
              <td>
              ...
              <td>
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end p-2">
                    <li>
                      <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_fuel"><i className="ti ti-edit me-1" />Edit</a>
                    </li>
                    <li>
                      <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_fuel"><i className="ti ti-trash me-1" />Delete</a>
                    </li>
                  </ul>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Diesel</a></h6>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Electric</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">CNG</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Hybrid</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
    ...
    <div className="modal-dialog modal-dialog-centered modal-md">
      <div className="modal-content">
        ...
        <div className="modal-body pb-1">
          <div className="mb-3">
            <label className="form-label">Name <span className="text-danger">*</span></label>
            <input type="text" className="form-control" placeholder="Petrol" />
          </div>
        </div>
        <div className="modal-footer">
