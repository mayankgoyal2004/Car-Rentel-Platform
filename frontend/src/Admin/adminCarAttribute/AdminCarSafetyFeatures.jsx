    ...
    <div className="content me-4">
      ...
      <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
        <div className="my-auto mb-2">
          ...
          <nav>
            <ol className="breadcrumb mb-0">
              ...
              <li className="breadcrumb-item active" aria-current="page">Safety Features</li>
            </ol>
          </nav>
        </div>
        <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
          ...
          <div className="mb-2">
            <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_safety_feature" className="btn btn-primary d-flex align-items-center"><i className="ti ti-plus me-2" />Add New Safety Feature</a>
          </div>
        </div>
      </div>
      {/* /Breadcrumb */}
        ...
        <table className="table datatable">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Active Head Restraints</a></h6>
              </td>
              <td>
              ...
              <td>
                <div className="dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end p-2">
                    <li>
                      <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_safety_feature"><i className="ti ti-edit me-1" />Edit</a>
                    </li>
                    <li>
                      <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_safety_feature"><i className="ti ti-trash me-1" />Delete</a>
                    </li>
                  </ul>
                </div>
              </td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Adaptive Headlights</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Blind-spot warning</a></h6>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Brake Assist</a></h6>
              </td>
              <td>
                <span className="badge badge-danger-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Inactive
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Lane Keeping Assist</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Parking Assist Systems</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Forward Collision Warning</a></h6>
              </td>
              <td>
                <span className="badge badge-danger-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Inactive
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Side View Camera</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Pedestrian Detection</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
            ...
            <tr>
              ...
              <td>
                <h6 className="fw-medium"><a href="javascript:void(0);">Backup Camera</a></h6>
              </td>
              <td>
                <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                  <i className="ti ti-point-filled me-1" />Active
    ...
    <div className="modal-dialog modal-dialog-centered modal-md">
      <div className="modal-content">
        ...
        <div className="modal-body pb-1">
          <div className="mb-3">
            <label className="form-label">Safety Feature <span className="text-danger">*</span></label>
    ...
    <div className="modal-dialog modal-dialog-centered modal-md">
      <div className="modal-content">
        ...
        <div className="modal-body pb-1">
          <div className="mb-3">
            <label className="form-label">Safety Feature <span className="text-danger">*</span></label>
            <input type="text" className="form-control" placeholder="Active Head Restraints" />
          </div>
        </div>
        <div className="modal-footer">
    ...
    <div className="modal-dialog modal-dialog-centered modal-sm">
      <div className="modal-content">
        <div className="modal-body text-center">
          ...
          <p className="mb-3">Are you sure you want to delete safety feature?</p>
          <div className="d-flex justify-content-center">
            <a href="javascript:void(0);" className="btn btn-light me-3" data-bs-dismiss="modal">Cancel</a>
