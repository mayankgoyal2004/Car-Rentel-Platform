  ...
  <div className="content me-4">
    ...
    <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
      ...
      <div className="d-flex my-xl-auto right-content align-items-center flex-wrap ">
        ...
        <div className="mb-2">
          <a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#add_type" className="btn btn-primary d-flex align-items-center"><i className="ti ti-plus me-2" />Add New Type</a>
        </div>
      </div>
    </div>
    {/* /Breadcrumb */}
      ...
      <table className="table datatable">
        ...
        <tbody>
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Sedan</a></h6>
            </td>
            <td>
            ...
            <td>
              <div className="dropdown">
                ...
                <ul className="dropdown-menu dropdown-menu-end p-2">
                  <li>
                    <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#edit_type"><i className="ti ti-edit me-1" />Edit</a>
                  </li>
                  <li>
                    <a className="dropdown-item rounded-1" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#delete_type"><i className="ti ti-trash me-1" />Delete</a>
                  </li>
                </ul>
              </div>
            </td>
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Hatchback</a></h6>
            </td>
            <td>
              <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Active
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">SUV</a></h6>
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Coupes</a></h6>
            </td>
            <td>
              <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Active
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Convertible</a></h6>
            </td>
            <td>
              <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Active
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Pickup Truck</a></h6>
            </td>
            <td>
              <span className="badge badge-danger-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Inactive
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Sport</a></h6>
            </td>
            <td>
              <span className="badge badge-danger-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Inactive
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Minivan</a></h6>
            </td>
            <td>
              <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Active
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">EV</a></h6>
            </td>
            <td>
              <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Active
          ...
          <tr>
            ...
            <td>
              <h6 className="fw-medium"><a href="javascript:void(0);">Wagon</a></h6>
            </td>
            <td>
              <span className="badge badge-success-transparent d-inline-flex align-items-center badge-sm">
                <i className="ti ti-point-filled me-1" />Active
