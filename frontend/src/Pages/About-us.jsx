      ...
      <div className="main-wrapper">
              ...
              <div className="col-lg-6">
                <div className="about-img">
                  ...
                  <div className="abt-img">
                    <img
                      src="/user-assets/img/about-us.png"
                      className="img-fluid"
                      alt="About us"
                    />
                  </div>
        ...
        <section className="section services bg-light-primary">
          <div className="service-right">
            <img
              src="/user-assets/img/bg/service-right.svg"
              className="img-fluid"
              alt="services right"
            />
          </div>
                  ...
                  <div className="services-group">
                    <div className="services-icon border-secondary">
                      <img
                        ...
                        src="/user-assets/img/icons/services-icon-01.svg"
                  ...
                  <div className="services-group">
                    <div className="services-icon border-warning">
                      <img
                        ...
                        src="/user-assets/img/icons/services-icon-02.svg"
                        alt="Choose Locations"
                      />
                    </div>
                    <div className="services-content">
                  ...
                  <div className="services-group">
                    <div className="services-icon border-dark">
                      <img
                        ...
                        src="/user-assets/img/icons/services-icon-03.svg"
                        alt="Choose Locations"
                      />
                    </div>
                    <div className="services-content">
                  ...
                  <div className="count-group flex-fill">
                    <div className="customer-count d-flex align-items-center">
                      <div className="count-img">
                        <img
                          src="/user-assets/img/icons/bx-heart.svg"
                          alt="Icon"
                        />
                      </div>
                ...
                <div className="col-lg-3 col-md-6 col-12 d-flex">
                  <div className="count-group flex-fill">
                    <div className="customer-count d-flex align-items-center">
                      <div className="count-img">
                        <img
                          src="/user-assets/img/icons/bx-car.svg"
                          alt="Icon"
                        />
                      </div>
                      <div className="count-content">
                ...
                <div className="col-lg-3 col-md-6 col-12 d-flex">
                  <div className="count-group flex-fill">
                    <div className="customer-count d-flex align-items-center">
                      ...
                      <div className="count-content">
                        <h4>
                          <span className="counterUp">200</span>K+
                        </h4>
                        <p>Total Kilometer</p>
                      </div>
                    </div>
        ...
        <section className="section why-choose">
          <div className="choose-left">
            <img
              src="/user-assets/img/bg/choose-left.png"
              className="img-fluid"
              alt="Why Choose Us"
            />
          </div>
                  ...
                  <div className="card flex-fill">
                    <div className="card-body">
                      <div className="choose-img choose-black">
                        <img
                          src="/user-assets/img/icons/bx-selection.svg"
                          alt="Icon"
                        />
                      </div>
                  ...
                  <div className="card flex-fill">
                    <div className="card-body">
                      <div className="choose-img choose-secondary">
                        <img
                          src="/user-assets/img/icons/bx-crown.svg"
                          alt="Icon"
                        />
                      </div>
                      <div className="choose-content">
                  ...
                  <div className="card flex-fill">
                    <div className="card-body">
                      <div className="choose-img choose-primary">
                        <img
                          src="/user-assets/img/icons/bx-user-check.svg"
                          alt="Icon"
                        />
                      </div>
                      <div className="choose-content">
