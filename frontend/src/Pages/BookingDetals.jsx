...
const BookingDetals = () => {
              ...
              <div className="booking-information-main">
                <form action={`/booking-payment/${id}`}>
                  <div className="booking-information-card">
                    <div className="booking-info-head justify-content-between">
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <a href="javascript:void(0);" className="btn btn-secondary ms-3" data-bs-toggle="modal" data-bs-target="#sign_in_modal"><i className="bx bx-user me-2" />Sign In</a>
                      </div>
                    </div>
                    <div className="booking-info-body">
                      <div className="row">
                        ...
                        <div className="col-md-6">
                          <div className="input-block">
                            <label className="form-label">No of Persons <span className="text-danger"> *</span></label>	
                        ...
                        <div className="col-md-4">
                          <div className="input-block">	
                            <label className="form-label">Enter City <span className="text-danger"> *</span></label>											
                        ...
                        <div className="col-md-12">
                          <div className="input-block">	
                            ...
                            <textarea className="form-control" placeholder="Enter Additional Information" rows={5} defaultValue={""} />
                          </div>
                        </div>
                        <div className="col-md-12">
                          <div className="input-block m-0">
                            <label className="custom_check d-inline-flex location-check m-0"><span>I have Read and Accept Terms &amp; Conditions</span> <span className="text-danger"> *</span>
                  ...
                  <div className="booking-info-btns d-flex justify-content-end">
                    <Link to="/booking-add-on" className="btn btn-secondary">Back to Extra Services</Link>
                    <button className="btn btn-primary continue-book-btn" type="submit">Confirm &amp; Pay Now</button>
                  </div>
                </form>
              </div>
            </div>
                    ...
                    <div className="accordion-header p-3 d-flex align-center justify-content-between">
                      <div className="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#accordion_collapse_three" aria-expanded="true">
                        <div className="booking-sidebar-head p-0 d-flex justify-content-between align-items-center">
                          <h5>Location &amp; Time<i className="fas fa-chevron-down" /></h5>
                        </div>
                      </div>
                      <Link to="/booking-checkout" className="d-flex align-items-center sidebar-edit"><i className="bx bx-edit-alt me-2" />Edit</Link>
                    </div>
                ...
                <div className="booking-sidebar-card">
                  <div className="accordion-item border-0 mb-4">
                    <div className="accordion-header d-flex align-center justify-content-between p-3">
                      <div className="accordion-button collapsed" role="button" data-bs-toggle="collapse" data-bs-target="#accordion_collapse_four" aria-expanded="true">
                        <div className="booking-sidebar-head p-0 d-flex justify-content-between align-items-center">
                          <h5>Extra Services<i className="fas fa-chevron-down" /></h5>
                        </div>
                        <Link to="/booking-add-on"  className="d-flex align-items-center sidebar-edit"><i className="bx bx-edit-alt me-2" />Edit</Link>
                      </div>
                    </div>
                    <div id="accordion_collapse_four" className="accordion-collapse collapse">
                      <div className="booking-sidebar-body">
                        <div className="booking-vehicle-rates">
                          <ul className="mt-0">
                            <li>
                          ...
                          <ul className="acting-driver-list">
                            <li className="d-block">
                              <div className="driver-profile-info">
                                <span className="driver-profile"><img src="/user-assets/img/drivers/driver-02.jpg" alt="Img" /></span>
                              ...
                              <div className="change-driver">
                                <a href="javascript:void(0);" className="btn btn-secondary d-inline-flex align-items-center"><i className="bx bx-check-circle me-2" />Change Driver</a>
                              </div>
                            </li>
                          </ul>
                        </div>
                        ...
                        <form action="/booking-details">
                          <div className="d-flex align-items-center">
                            <div className="form-custom flex-fill">														
                              <input type="text" className="form-control mb-0" defaultValue="FIRSTBOOKING" />
                              <a href="#" className="coupon-close"><span><i className="bx bx-x" /></span></a>
                            </div>
                            <button type="submit" className="btn btn-secondary d-flex align-items-center apply-coupon-btn disabled ms-2">Apply<i className="feather-arrow-right ms-2" /></button>
                          </div>
                          <span className="coupen-applied-offter"><i className="bx bxs-offer" />Saved in this Booking </span>
                        </form>
                      </div>
                    </div>
                  </div>
  ...
  <div className="modal new-modal multi-step fade" id="sign_in_modal" data-keyboard="false" data-backdrop="static">
              ...
              <div className="login-auth">
                <div className="login-auth-wrap">
                  ...
                  <form action="/">
                    ...
                    <Link to="/" className="btn btn-outline-light w-100 btn-size mt-1">Sign In</Link>
                    ...
                    <div className="social-login">
                      <a href="#" className="d-flex align-items-center justify-content-center input-block btn google-login w-100"><span><img src="/user-assets/img/icons/google.svg" className="img-fluid" alt="Google" /></span>Log in with Google</a>
                    </div>
                    <div className="social-login">
                      <a href="#" className="d-flex align-items-center justify-content-center input-block btn google-login w-100"><span><img src="/user-assets/img/icons/facebook.svg" className="img-fluid" alt="Facebook" /></span>Log in with Facebook</a>
                    </div>
                    {/* /Social Login */}
                    <div className="text-center dont-have">Don't have an account ? <Link to="/register" >Sign Up</Link></div>
                  </form>							
                </div>
              </div>
            </div>
