                ...
                <div className="booking-wizard-lists">
                  <ul>
                    <li className="active activated">
                      <span>
                        <img
                          src="/user-assets/img/icons/payment-method-01.svg"
                          alt="Booking Icon"
                        />
                      </span>
                      <h6>Location &amp; Time</h6>
                            ...
                            <li>
                              <label className="payment_custom_check">
                                ...
                                <span className="payment_checkmark">
                                  <span className="checked-title">
                                    <img
                                      src="/user-assets/img/icons/payment-method-02.svg"
                                      alt="Img"
                                    />
                                  </span>
                                </span>
                            ...
                            <li>
                              <label className="payment_custom_check">
                                ...
                                <span className="payment_checkmark">
                                  <span className="checked-title">
                                    <img
                                      src="/user-assets/img/icons/payment-method-03.svg"
                                      alt="Img"
                                    />
                                  </span>
                                </span>
                            ...
                            <li>
                              <label className="payment_custom_check">
                                ...
                                <span className="payment_checkmark">
                                  <span className="checked-title">
                                    <img
                                      src="/user-assets/img/icons/payment-method-04.svg"
                                      alt="Img"
                                    />
                                  </span>
                                </span>
                                ...
                                <li>
                                  <label className="payment_custom_check">
                                    ...
                                    <span className="payment_checkmark">
                                      <span className="checked-title">
                                        <img
                                          src="/user-assets/img/icons/payment-card-01.svg"
                                          alt="Img"
                                        />
                                      </span>
                                      <small>
                                ...
                                <li>
                                  <label className="payment_custom_check">
                                    ...
                                    <span className="payment_checkmark">
                                      <span className="checked-title">
                                        <img
                                          src="/user-assets/img/icons/payment-card-02.svg"
                                          alt="Img"
                                        />
                                      </span>
                                      <small>
