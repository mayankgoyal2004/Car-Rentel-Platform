          ...
          <li>
            <div className="post-author">
              <div className="post-author-img">
                <img src="/user-assets/img/profiles/avatar-01.jpg" alt="author" />
              </div>
              <a href="javascript:void(0)"><span> John Doe </span></a>
            </div>
          </li>
          <li className="date-icon"><i className="fa-solid fa-calendar-days" /> October 6, 2022</li>
        </ul>
      </div>		            
    </div>	
    {/* /Breadscrumb Section */}	
    ...
    <div className="blog-section">
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6 col-md-6">
            <div className="bloginner-img">
              <img src="/user-assets/img/blog/blog-detail-01.jpg" className="img-fluid" alt="Blog" />											 
            </div>
          </div>
          <div className="col-lg-6 col-md-6">
            <div className="bloginner-img">
              <img src="/user-assets/img/blog/blog-detail-02.jpg" className="img-fluid" alt="Blog" />					 
            </div>	   
          </div>				
        </div>
          ...
          <div className="row">
            <div className="col-lg-4">
              <div className="sharelink d-flex align-items-center">
                <a href="javascript:void(0);" className="share-img"><i className="feather-share-2" /></a>
                <a href="javascript:void(0);" className="share-text">Share</a>
              </div>
            </div>
        ...
        <div className="blogdetails-pagination">
          <ul>
            <li>
              <Link to="/blog-details"  className="prev-link"><i className="fas fa-regular fa-arrow-left" /> Previous Post</Link>
              <Link to="/blog-details" ><h3>The Best SPA Salons For Your Relaxation</h3> </Link>
            </li>
            <li>
              <Link to="/blogDetails"  className="next-link">Next Post <i className="fas fa-regular fa-arrow-right" /> </Link>
              <Link to="/blog-details" ><h3>8 Amazing Tricks About Business</h3> </Link>
            </li>						
          </ul>				
        </div>	
        <div className="review-sec mb-0">
            ...
            <div className="review-header-group">
              <div className="review-widget-header">
                <span className="review-widget-img">
                  <img src="/user-assets/img/profiles/avatar-01.jpg" className="img-fluid" alt="Blog" />
                </span>
          ...
          <div className="review-card">
            <div className="review-header-group">
              <div className="review-widget-header">
                <span className="review-widget-img">
                  <img src="/user-assets/img/profiles/avatar-02.jpg" className="img-fluid" alt="Blog" />
                </span>
                <div className="review-design">
                  <h6>Casandra</h6>
                  <p>02 Jan 2023</p>
