          ...
          <div className="col-lg-3 d-flex col-md-6 col-12" data-aos="fade-down">
            <div className="price-card price-selected flex-fill">
              <div className="price-head">
                <h2>Save More with Smart Rental Plans</h2>
                <p>
                  Choose a plan, get onboard in minutes, and enjoy exclusive
                  savings on your next booking.
                </p>
              ...
              <div className="price-body">
                <img
                  className="img-fluid"
                  src="/user-assets/img/price-plan.png"
                  alt="Price Plan"
                />
              </div>
            </div>
              ...
              <div className="price-details">
                <ul>
                  ...
                  <li className="price-uncheck">
                    ...
                    No Flexible Timing or Extension
                  </li>
                </ul>
          ...
          <div className="col-lg-3 d-flex col-md-6 col-12" data-aos="fade-down">
            <div className="price-card flex-fill active">
              ...
              <div className="price-details">
                ...
                <Link to="/" className="btn viewdetails-btn btn-popular">
                  Choose Plan
                </Link>
              </div>
            </div>
