  ...
  const categories = [
    {
      name: "Sports Coupe",
      cars: 14,
      img: "/user-assets/img/category/category-01.png",
    },
    {
      name: "Sedan",
      cars: 12,
      img: "/user-assets/img/category/category-02.png",
    },
    {
      name: "Sports Car",
      cars: 35,
      img: "/user-assets/img/category/category-03.png",
    },
    {
      name: "Pickup",
      cars: 35,
      img: "/user-assets/img/category/category-04.png",
    },
    {
      name: "Family MPV",
      cars: 35,
      img: "/user-assets/img/category/category-05.png",
    },
    {
      name: "Crossover",
      cars: 30,
      img: "/user-assets/img/category/category-06.png",
    },
  ];
