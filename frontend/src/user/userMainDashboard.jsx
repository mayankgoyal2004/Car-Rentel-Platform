  ...
  <div className="container">
    ...
    <ul className="status-lists">
      <li className="approve-item">
        ...
        <a href="javascript:void(0);" className="view-detail">View Details</a>
      </li>
      <li>
        <div className="status-info">
        ...
        <a href="javascript:void(0);" className="close-link"><i className="feather-x" /></a>
      </li>
        ...
        <div className="widget-box flex-fill">
          <div className="widget-header">
            ...
            <div className="widget-icon">
              <span>
                <img src="/user-assets/img/icons/book-icon.svg" alt="icon" />
              </span>
            </div>
          </div>
          <Link to="user-booking" className="view-link">View all Bookings <i className="feather-arrow-right" /></Link>
        </div>
      </div>
      {/* /Widget Item */}
      {/* Widget Item */}
          ...
          <div className="widget-header">
            ...
            <div className="widget-icon">
              <span className="bg-warning">
                <img src="/user-assets/img/icons/balance-icon.svg" alt="icon" />
              </span>
            </div>
          </div>
          <Link to="user-wallet" className="view-link">View Balance <i className="feather-arrow-right" /></Link>
        </div>
      </div>
      {/* /Widget Item */}
      {/* Widget Item */}
          ...
          <div className="widget-header">
            ...
            <div className="widget-icon">
              <span className="bg-success">
                <img src="/user-assets/img/icons/transaction-icon.svg" alt="icon" />
              </span>
            </div>
          </div>
          <Link to="user-payment" className="view-link">View all Transactions <i className="feather-arrow-right" /></Link>
        </div>
      </div>
      {/* /Widget Item */}
      {/* Widget Item */}
          ...
          <div className="widget-header">
            ...
            <div className="widget-icon">
              <span className="bg-danger">
                <img src="/user-assets/img/icons/cars-icon.svg" alt="icon" />
              </span>
            </div>
          </div>
          <Link to="user-wishlist" className="view-link">Go to Wishlist <i className="feather-arrow-right" /></Link>
        </div>
      </div>
      {/* /Widget Item */}
    </div>				
            ...
            <div className="row align-items-center">
              ...
              <div className="col-sm-7 text-sm-end">
                <div className="booking-select">
                  ...
                  <Link to="user-booking" className="view-link">View all Bookings</Link>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <tr>
                    <td>
                      <div className="table-avatar">
                        ...
                        <div className="table-head-name flex-grow-1">
                          <Link to="user-booking">2018 Chevrolet Camaro</Link>
                          <p>Rent Type : Hourly</p>
                        </div>
                      </div>
                    </td>
                ...
                <tbody>
                  <tr>
                    <td className="border-0">
                      <div className="table-avatar">
                        <Link to="user-booking" className="avatar avatar-md flex-shrink-0">
                          <img className="avatar-img" src="/user-assets/img/cars/car-04.jpg" alt="Booking" />
                        </Link>
                        <div className="table-head-name flex-grow-1">
                          <Link to="user-booking">Ferrari 458 MM Speciale</Link>
                  ...
                  <tr>
                    <td className="border-0">
                      <div className="table-avatar">
                        <Link to="user-booking" className="avatar avatar-md flex-shrink-0">
                          <img className="avatar-img" src="/user-assets/img/cars/car-07.jpg" alt="Booking" />
                        </Link>
                        <div className="table-head-name flex-grow-1">
                          <Link to="user-booking">Chevrolet Pick Truck 3.5L</Link>
                          <p>Rent Type : Day</p>
                        </div>
                      </div>
                    </td>
